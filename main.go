...
func main() {
	...
	http.Handle(apiPath+"/user/upload", handlers.MethodMiddleware("PATCH")(uploadAvatarHandler))
	http.Handle(apiPath+"/user/settings", handlers.MethodMiddleware("PUT")(changeUserDataHandler))
